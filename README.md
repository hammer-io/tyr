...
| async generateBasicNodeProject(configs, filePath) | The configs json object should have the same format as the .tyrfile. The filePath is where the project will be created.,This generates the most basic node files including the src folder, index.html, index.js, package.json, README, and node-config folder. It returns the configs object.                                                                     |
